...
public class QuizNA extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//DB接続
		opener = new MySQLHelperNA(this, MySQLHelperNA.DB_NAME, null, MySQLHelperNA.DB_VERSION);
		...
		//クエリ生成＆問い合わせ
		String query = "select * from " + MySQLHelperNA.TBL_NAME+";";
...
/>
	...
	*/
	...
	mydbConecter.close();
       ...
       // mp.start();
        tokei();
        scoreTV.setText("Rate："+Integer.toString(QGlobal.score));
