...
public class Quiz extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//DB接続
		opener = new MySQLHelper(this, MySQLHelper.DB_NAME, null, MySQLHelper.DB_VERSION);
		...
		//クエリ生成＆問い合わせ
		String query = "select * from " + MySQLHelper.TBL_NAME+";";
	...
	*/
	...
	mydbConecter.close();
       ...
       // mp.start();
		...
		countTV.setText(Integer.toString(QGlobal.count)+"/"+ QGlobal.mode);
