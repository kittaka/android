...
public class Quizhard extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//DB接続
		opener = new MySQLHelperhard(this, MySQLHelperhard.DB_NAME, null, MySQLHelperhard.DB_VERSION);
		...
		//クエリ生成＆問い合わせ
		String query = "select * from " + MySQLHelperhard.TBL_NAME+";";
